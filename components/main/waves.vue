<template>
  ...
  >
    <path
      data-rellax-speed="-1"
      :class="`rellax-waves background-${color}-alpha-9 blur-1-dark-alpha-2`"
 ...
 s-74.9,0-112.4,0s-75.1,0-94,0H0V-2z"
    ...
    <path
      data-rellax-speed="-2"
      :class="`rellax-waves background-${color}-alpha-7 blur-1-dark-alpha-2`"
 ...
 s-74.9,0-112.4,0s-75.1,0-94,0H0V34z"
    ...
    <path
      data-rellax-speed="-4"
      :class="`rellax-waves background-${color}-alpha-5 blur-1-dark-alpha-2`"
 ...
 s-75.1,0-94,0H0V112z"
    ...
    <path
      data-rellax-speed="-3"
      :class="`rellax-waves background-${color}-alpha-3 blur-1-dark-alpha-2`"
...
export default {
  ...
  mounted() {
    this.rellax = new Rellax('.rellax-waves')
  },
}
</script>
