<template>
  ...
  >
    <path
      ...
      :class="`wave background-${color}-alpha-9`"
 ...
 s-74.9,0-112.4,0s-75.1,0-94,0H0V-2z"
    ...
    <path
      v-parallax="{ speed: 1 }"
      :class="`wave background-${color}-alpha-7 `"
 ...
 s-74.9,0-112.4,0s-75.1,0-94,0H0V34z"
    ...
    <path
      v-parallax="{ speed: 2 }"
      :class="`wave background-${color}-alpha-5`"
 ...
 s-75.1,0-94,0H0V112z"
    ...
    <path
      v-parallax="{ speed: 3 }"
      :class="`wave background-${color}-alpha-3`"
 ...
 s-75.1,0-94,0H0V107z"
    ...
    <path
      v-parallax="{ speed: 4 }"
      :class="`wave background-${color}-alpha-1`"
